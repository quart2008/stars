...
$PBExportComments$PFC Window Preferences service <logic>
forward
global type n_cst_winsrv_preference from n_cst_winsrv
end type
end forward
...
constant string lcs_testdefault='$%^'
...
as_value = ProfileString (as_KeyOrIni, as_IniSection, as_SubKey, lcs_testdefault)
If as_value=lcs_testdefault Then
	as_Value = as_default
	Return 0
End If
Return 1
...
//
//	Object:  n_cst_winsrv_preference
//
//	Description:
