...
$PBExportComments$PFC Conversion Service class (inherited from n_base) <logic>
forward
global type n_cst_conversion from n_base
end type
end forward

global type n_cst_conversion from n_base autoinstantiate
end type
