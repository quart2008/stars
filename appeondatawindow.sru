HA$PBExportHeader$appeondatawindow.sru
forward
...
public function boolean of_isgraph ()
...
BlobEdit(bInteger, 1, Integer(110))
bData += bInteger;
...
// 
//------------------------------------------------------------------------------
// Function: appeondatawindow::of_isgraph()
//------------------------------------------------------------------------------
// Description: 
// 
//	
...
Long ll_Processing
ll_Processing = Long(THIS.DESCRIBE("datawindow.processing"))
IF ll_Processing = 3 THEN
	RETURN TRUE
ELSE
	RETURN FALSE
END IF
...
BlobEdit(lblob_Integer, 1, Integer(110))
...
// Converts the obtained information into specific XML string 
IF 1 <> ConvertDWAP_J(REF lblob_Data, REF lstru_info_a, REF ll_Address, REF ll_Changes, ab_blob, ab_withdddw) THEN RETURN -1
