HA$PBExportHeader$n_xls_format_v5.sru
forward
...
public function int of_set_num_format(string AS_NUM_FORMAT);int li_ret = 1
...
li_cch        = len(ls_rgch);
li_record     = 49           //0x31
li_length     = 15 + li_cch  //0x0F + li_cch
li_reserved   = 0            //0x00;
...
uint li_icv        // fg and bg pattern colors
uint li_fill       // Fill and border line style
uint li_border1    // Border line style and color
uint li_border2    // Border color
...
lb_data   = invo_sub.of_pack('v', li_record) +&
            ...
            invo_sub.of_pack('v', li_align) +&
            invo_sub.of_pack('v', li_icv) +&
            invo_sub.of_pack('v', li_fill) +&
            invo_sub.of_pack('v', li_border1) +&
            invo_sub.of_pack('v', li_border2) 
