...
// header info		header(height=82… color=	/* one if have Totals */
//						none
...
//		count(	/*col_name*/
//		group		/*level #*/
//	summary band col	compute(band=summary.1…	/* one for each break &/or total column */
//		x=
//		width=
//		format=
//		count(	/*col_name*/
