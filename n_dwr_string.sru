HA$PBExportHeader$n_dwr_string.sru
forward
...
do while ll_count<ll_length
   ...
   If li_ascii=8   or         /* BackSpae */             		li_ascii=9 	or			/* Tab */		 					li_ascii=10 or			/* NewLine */						li_ascii=11 or			/* Vertical Tab */				li_ascii=12 or			/* Form Feed */					li_ascii=13 or			/* Carriage Return */			li_ascii=32 Then		/* Space */
...
do while ll_count<ll_length
   ...
   If li_ascii=60 or         /* < less than */    		li_ascii=61 or			/* = equal */		 		li_ascii=62 Then		/* > greater than */
...
do while ll_count<ll_length
   ...
   If li_ascii=40 or         /*        (        left parenthesis */    		li_ascii=41 or			/*       )       right parenthesis */	 		li_ascii=43 or			/* + addition */				 		li_ascii=45 or			/* - subtraction */			 		li_ascii=42 or			/* * multiplication */		 		li_ascii=47 or			/* / division */				 		li_ascii=94 Then		/* ^ power */
...
//
//   Returns:        Boolean
//                  True if the string only contains Numeric
//                  characters.
//                  If any argument's value is NULL, function returns NULL.
//
//   Description:     Determines whether a string contains only
//                  numeric characters.
//
//////////////////////////////////////////////////////////////////////////////
//
...
public function string of_remove_last_spaces_and_empty_rows(string AS_SOURCE);//////////////////////////////////////////////////////////////////////////////
//
//   Function:        of_remove_last_spaces_and_empty_rows
//
//   Access:          public
//
//   Arguments:
...
//
//   Returns:        String
//                  Returns string with removed last spaces and last empty rows
//                  If any argument's value is NULL, function returns NULL.
//
//////////////////////////////////////////////////////////////////////////////
//
...
cnt = this.of_parsetoarray ( as_source, '~r~n', s )
for i = cnt to 1 step -1
   s [ i ]  = this.of_righttrim ( s [ i ]  )
...
public function string of_remove_last_spaces_empty_rows(string AS_SOURCE);//////////////////////////////////////////////////////////////////////////////
//
//   Function:        of_remove_last_spaces_empty_rows
//
//   Access:          public
//
//   Arguments:
