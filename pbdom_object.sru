...
public function pbdom_object uf_createdomobject (string as_type)
...
public function pbdom_object uf_createdomobject (string as_type);
pbdom_object lnv_domObj

as_type = lower(as_type)
choose case as_type
	case 'element'
		lnv_domObj = create pbdom_element
	case 'attribute'
		lnv_domObj = create pbdom_attribute
	case 'doctype'
		lnv_domObj = create pbdom_doctype
	case 'document'
		lnv_domObj = create pbdom_document
	case 'processinginstruction'
		lnv_domObj = create pbdom_processingInstruction
	case 'text'
		lnv_domObj = create pbdom_text
	case else
		messageBox('Error!', 'Error pbdom type - ' + as_type)
end choose
