...
$PBExportComments$PFC INIFile service (inherited from n_base) <logic>
forward
global type n_cst_inifile from n_base
end type
end forward

global type n_cst_inifile from n_base autoinstantiate
end type
