...
forward
global type u_calendar from u_base
end type
type dw_cal from u_dw within u_calendar
end type
end forward
...
Date	id_holiday[]
Date	id_markedday[]
Boolean	ib_holidaybold=True
Boolean	ib_sundaybold=False
Boolean	ib_saturdaybold=False
Boolean	ib_markeddaybold=True
Long	il_sundaycolor=33554432       		//Window Text	
Long	il_saturdaycolor=33554432    		//Window Text	
Long	il_holidaycolor=134217741			//Highlight
Long	il_markeddaycolor=134217742		//Highlight Text
...
dw_cal.Modify("st_month.text = '" + ls_monthname + " " + string(li_year) + "'")
...
//	(Returns:  		None)
//
//	Description:	Goto to the current day.
//
//////////////////////////////////////////////////////////////////////////////
//
//	10/09/03	GaryR	Track 5915c	Add today button to calendar
//
//////////////////////////////////////////////////////////////////////////////

// Set the new date.
of_SetDate (Today(), True)
