$PBExportHeader$n_cst_dwsrv_resize.sru
$PBExportComments$PFC DataWindow Resize service <logic>
forward
global type n_cst_dwsrv_resize from n_cst_dwsrv
end type
type os_resize from structure within n_cst_dwsrv_resize
end type
end forward
...
public function integer of_setrequester (u_dw adw_requestor)
...
ls_describeret = adw_Requestor.Describe("DataWindow.Processing")
