...
$PBExportComments$PFC Window  Sheet Manager service <logic>
forward
global type n_cst_winsrv_sheetmanager from n_cst_winsrv
end type
end forward
...
public function integer of_setrequestor (w_main aw_requestor)
end prototypes
